...
namespace DI
{
    public class DIContainer
    {
        ...
        public void RegisterInstance<T>(string tag, T instance)
        {
            ...
            {
                throw new InvalidOperationException($"DI: Factory with tag {key.Item1} and type " +
                                                    $"{key.Item2.FullName} has already registered.");
            }
        ...
        public T Resolve<T>(string tag = null)
        {
            ...
            throw new InvalidOperationException($"Couldn't find dependency for tag {tag}" +
                                                $" and type {key.Item2.FullName}.");
        }
